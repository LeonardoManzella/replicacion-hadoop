...
#include <commons/process.h> 	//Para Obtener ID de proceso y thread actual, para la "Macro_CheckError"
 ...
 *	NOTA2: Con  NODEBUG ya no imprime el mensaje de Error, pero sigue controlando y retornando los errores   */
	...
	#define FILE_LONGITUD_NOMBRE 	50
	#define MD5_LENGTH 				33		//La longitud del MD5 debe ser de 33 porque son 32 caracteres + 1 caracter de Fin de String (\0)

	#define NODO_LONGITUD_NOMBRE 	50

	#define DIR_LONGITUD_NOMBRE 50	//Tamaño maximo del nombre del Directorio
	#define DIR_CANTIDAD_MAXIMA 1024	//Cantidad Maxima de Directorios dentro del File System, Asi lo especifica el Enunciado
	...
	//Tamaño Maximo de una Ruta cualquiera dentro del File System, Nodos o Marta.
	//NOTA: ese "+1" es por los "/", Uno por cada Directorio
	#define RUTA_LONGITUD_MAXIMA	(DIR_CANTIDAD_MAXIMA*(DIR_LONGITUD_NOMBRE+1))

	//Tamaño Aproximado con el que Alcanze para cualquier Ruta
	...
	/*	La Idea Estas 2 Macros es que vallan Juntas.
	...
	*	Si no terminan de Entender su Funcionamiento, les recomiendo preguntar a LEONARDO o leer este Link:  http://c.learncodethehardway.org/book/ex20.html     */
	...
	/*	Dado la ruta completa en linux a un archivo, obtiene su MD5.
	 Devuelve un Puntero a Char, que es un string de 33 caracteres (32 del MD5 + 1 de caracter fin de string \0)
	 Ante error, devuelve NULL
	 */
